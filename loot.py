...
Tracks credentials, hashes, tokens, shell access, and sensitive files
discovered during an engagement. Persisted as JSON alongside session notes.
"""
...
class Loot:
    ...
    def merge(self, extracted: dict) -> int:
        """Merge an extracted loot dict into this object. Returns count of new items added."""
        count = 0
